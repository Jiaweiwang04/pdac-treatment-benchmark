...
当前仅推进Track A，Track B冻结，不因其临床指标缺失设置新的纳入门槛。本轮将515名主集合患者分为435名开发患者和80名Core测试患者，再从开发集中抽取25名Pilot患者。主标签继续沿用[四类标签定义](treatment_label_definition_v2.0.md)，知识截止日固定为2026-09-12；划分执行日期为2026-09-13，不改变知识截止日。
