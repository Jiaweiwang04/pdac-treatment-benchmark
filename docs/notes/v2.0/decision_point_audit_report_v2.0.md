...
[结构化病例示例](../../../code/results/v2.0/02_decision_points/complete_case_v2.0.html)包含150条临床原记录、3份病理、10个标本及关联分子记录。原字段和空值均保留，未来信息与报告时间未知分别标记。本例用于核查阅读格式，不是pilot抽样或专家审核金标准。
